...
#Execute SAST Scan using SonarCloud in GCP DevSecOps Pipeline
  - name: maven:3-jdk-11
    entrypoint: mvn
    args: ['verify', 'sonar:sonar','-Dsonar.host.url=https://sonarcloud.io','-Dsonar.organization=devsecops-nzastudios','-Dsonar.projectKey=devsecops-nzastudios','-Dsonar.login=${_SONAR_TOKEN}']
...
artifacts:
  objects:
    location: 'gs://gcpdevsecops-reports-nza'
    paths:
      - zap_report_2024.html
